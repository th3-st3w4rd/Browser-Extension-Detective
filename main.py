...
def main():
    ...
    os_name = CaseHandler.detect_detective_system()
    drive_choices = CaseHandler.locate_drives(os_name.system.lower())
    print(type(drive_choices))
    ...
    parser.add_argument("-t", "--target-drive", choices=drive_choices, help="Sets the target drive to search.")
